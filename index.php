...
<body>
    ...
    <header>
        ...
        <div class="bottom" id="top-fixed-bar">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-4 col-xs-5 nextlogo">
                        <div class="block block-2">
                            <?php include("food-cart-sidebar.php"); ?>
                        </div>
                        <div class="search hidden-xs hidden-sm">
                            <form action="#" class="search-form">
                                <input type="text" name="s" class="form-control" placeholder="Search food here">
                    ...
                    <div class="col-md-9 col-xs-12">
                        ...
                        <div class="product-list grid_full grid_sidebar grid-uniform">
                            <?php
                                ...
                                $product_rs = $db->query("select id, name, regular_price, offer_price, food_pic_id from item_master where type_id = 1 order by id desc");
                                while(list($_id, $_name, $_reg_price, $_offer_price, $_food_pic_id) = $product_rs->fetch_row()) :

                                if($_food_pic_id != null) {
                                    $img_src = "img/food-img/" . $_name . "-" . $_food_pic_id . ".jpg";
                                } else {
                                    $img_src = "img/food-img/Pizza Item-1.jpg";
                                }
                            ?>
                            <div class="product-list-item">
                                <div class="product-item-img">
                                    <a href="#"><img src="<?php echo $img_src; ?>" alt="images" class="img-responsive"></a>
                                    <div class="label label-2 red label-top-20">Hot</div>
                                </div>
                                <div class="product-item-info">
                                    <h3><a href="#" title=""><?php echo $_name; ?></a></h3>
                                    ...
                                    <div class="button-ver2">
                                        <p data-id='<?php echo $_id; ?>' data-name='<?php echo $_name; ?>' data-price='<?php echo $_offer_price; ?>' data-food-img='<?php echo $_food_pic_id; ?>' class="addcart-ver2 single-food-btn" title="Add to cart"><span class="icon"></span>ADD TO CART</p>
    ...
    <script>
        $height = $('#top-fixed-bar').offset().top;
        $(window).bind('scroll', function () {
            // alert($height);
            if ($(window).scrollTop() > $height) {
                $('#top-fixed-bar').addClass('sticky');
            } else {
                $('#top-fixed-bar').removeClass('sticky');
            }
        });
    </script>
</body>

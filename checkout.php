                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="note" id="address" tabindex="2" class="form-control form-textarea"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="aside-order">
                            ...
                            <table class="table table-product">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="product-name">Canon EOS 6D 20.2 MP</td>
                                        <td class="product-quantity">x 1</td>
                                        <td class="product-total">$1,499.00</td>
                                    </tr>
                                    <tr>
                                        <td class="product-name">Canon EOS 6D 20.2 MP</td>
                                        <td class="product-quantity">x 1</td>
                            ...
                            <ul class="tabs-first">
                                ...
                                <li><span class="text">Total:</span><span class="cart-number big-total-number pull-right">$1,750.00</span></li>
                            </ul>
